...
class TestGames(TestCase):
    ...
    def test_the_game_can_add_multiple_worlds(self):
        ...
        g = game(n_agent_instances=3, n_world_instances=4)
        g.add_world_class(worlds.BernoulliMultiArmedBandits, n_arms=5, name="MAB5")
        g.add_world_class(worlds.BernoulliMultiArmedBandits, n_arms=4, name="MAB4")
    ...
    def test_the_game_can_add_multiple_agents_to_multiple_worlds(self):
        ...
        g = game(n_agent_instances=3, n_world_instances=4)
        g.add_world_class(worlds.BernoulliMultiArmedBandits, n_arms=5, name="MAB5A")
        g.add_world_class(worlds.BernoulliMultiArmedBandits, n_arms=5, name="MAB5B")
        g.add_agent_class(agents.TS, n_arms=5)
        g.add_agent_class(agents.EGreedy, n_arms=5, q_start=100, epsilon=0.2)
    ...
    def test_the_game_raise_error_if_worlds_are_assigned_if_game_is_run(self):
        ...
        g.run_experiments(T=10)
        with self.assertRaises(Exception) as context:
            g.add_world_class(worlds.BernoulliMultiArmedBandits, n_arms=3, name="MAB5")
        self.assertTrue(
